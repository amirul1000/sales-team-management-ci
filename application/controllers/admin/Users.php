...
$updated_at = "";
		...
		$params = array(
					 'representative_id' => html_escape($this->input->post('representative_id')),
...
$this->db->or_like('representative_id', $key, 'both');
...
$this->db->or_like('status', $key, 'both');
	...
	function export($export_type='CSV'){
	  if($export_type=='CSV'){	
		   ...
		   $header = array("Id","Representative Id","Email","Password","Title","First Name","Last Name","Company","Address","City","State","Zip","Country Id","Created At","Updated At","Type","Status"); 
		   fputcsv($file, $header);
