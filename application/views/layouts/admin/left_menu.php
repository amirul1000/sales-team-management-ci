...
<nav>
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if($this->router->fetch_class()=="earnings"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/earnings/index'); ?>"><i class="icon_table"></i>Earnings</a></li>
<li <?php if($this->router->fetch_class()=="messages"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/messages/index'); ?>"><i class="icon_table"></i>Messages</a></li>
<li <?php if($this->router->fetch_class()=="representative"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/representative/index'); ?>"><i class="icon_table"></i>Representative</a></li>
<li <?php if($this->router->fetch_class()=="work"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/work/index'); ?>"><i class="icon_table"></i>Work</a></li>
